...
public class ConvertorServerTest implements Runnable, AutoCloseable{
	...
	public static void main(String[] args) {
		...
		byte[] cmd_proto = {(byte) 0x8A,0x00,0x00,(byte) 0xC5,0x12,0x00,0x00,0x15,0x00,0x19,0x00
				,(byte) 0xA0,0x07,0x13,0x00,0x06,0x00,0x05,0x00,(byte) 0xC8,0x00,0x4A
				,0x00,(byte) 0xF0,(byte) 0xFF,(byte) 0xFF,(byte) 0xE3,0x1B,0x0E,(byte) 0xB7,0x0C,0x02,0x00
				,0x12,0x00,0x26,0x02
		...
		// TODO Auto-generated method stub
			...
			while (true) {
				try {
					...
					out.writeObject(new RawSensorData(data.cmd, System
							.currentTimeMillis()));
